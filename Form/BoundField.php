...
class Gatuf_Form_BoundField {
    ...
    public function labelTag($contents=null, $attrs=array()) {
        ...
        return new Gatuf_Template_SafeString(sprintf('<label for="%s"%s>%s</label>',
    ...
    {
        Gatuf::loadFunction('Gatuf_Form_renderErrorsAsHTML');
        return new Gatuf_Template_SafeString(Gatuf_Form_renderErrorsAsHTML($this->errors), true);
    }
