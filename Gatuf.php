...
class Gatuf {
	public static function start($config) {
		...
		if (Gatuf::config('debug', false)) {
			$GLOBALS['_GATUF_debug_data'] = array();
		}
	...
	public static function config($cfg, $default = '') {
	...
	public static function prefixconfig($pfx, $strip=false) {
		$ret = array();
		$pfx_len = strlen($pfx);
